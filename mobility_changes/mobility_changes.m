...
figure()
hold on
plot(mobility_dates(10:50),AT_mean_outflux(10:50),linewidth=1.1)
plot(mobility_dates(10:50),CH_mean_outflux(10:50),linewidth=1.1)
plot(mobility_dates(10:50),DK_mean_outflux(10:50),linewidth=1.1)
plot(mobility_dates(10:50),IR_mean_outflux(10:50),linewidth=1.1)
plot(mobility_dates(10:50),IL_mean_outflux(10:50),linewidth=1.1)
plot(mobility_dates(10:50),LO_mean_outflux(10:50),linewidth=1.1)
set(gca,'FontSize',14)
legend({'AT','CH','DK','IR','IL','LO'},'Location','southwest')
xlabel("Date",'FontSize',18)
ylabel("Mobility changes wrt baseline [%]",'FontSize',18)
title("Google Mobility Data",'FontSize',18)
hold off
