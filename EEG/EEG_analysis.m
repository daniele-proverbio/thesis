...
load('20170809_1_30R15I75L.mat')
ecg=EEG(1:1000:end);

figure('Position',[100 100 600 300]);
plot((1:length(EEG))/2000,EEG)
xlabel('Time [seconds]',fontsize=16)
ylabel('EEG [mV]',fontsize=16)

%% Recurrence plot
% If you find this toolbox useful, please cite the following paper:
% [1]	H. Yang, �Multiscale Recurrence Quantifwication Analysis of Spatial Vectorcardiogram (VCG)
...
grid on;
set(gca,'CameraPosition',[25.919 7.36 13.854]);
